...
public class ShoppingActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shopping4);
        ...
        url = "http://jaeyooou.dothome.co.kr/Get_url_Autumn.php"; // json 저장 된 url
    ...
    private class Description extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            //진행다일로그 시작
            progressDialog = new ProgressDialog(ShoppingActivity4.this);
